---
name: seedance-vfx
description: "This skill should be used when the user asks for visual effects, particle systems, destruction, fire, smoke, water, energy effects, compositing, physics contracts, or spectacle design in Seedance 2.0."
license: MIT
user-invocable: true
user-invokable: true
tags:
